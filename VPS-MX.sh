...
[[ $(find /etc/newadm/ger-user -name nombre.log|grep -w "nombre.log"|head -1) ]] || wget -O /etc/newadm/ger-user/nombre.log https://raw.githubusercontent.com/sys-on/VPS-MX-8.0/main/ArchivosUtilitarios/nombre.log &>/dev/null
