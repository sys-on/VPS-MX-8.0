...
unset name
while [[ ${name} = "" ]]; do
echo -ne "\033[1;37m $(fun_trans "Novo nome de host"): " && read name
tput cuu1 && tput dl1
done
...
echo -e "\033[1;33m $(fun_trans "Host NÃO modificado")!"
fi
msg -bar
return
}
...
cambiopass () {
echo -e "${cor[3]} $(fun_trans "Esta ferramenta altera a senha do seu servidor vps")"
echo -e "${cor[3]} $(fun_trans "Esta senha é usada como usuário") root"
msg -bar
echo -ne " $(fun_trans "Deseja Seguir?") [S/N]: "; read x
[[ $x = @(n|N) ]] && msg -bar && return
msg -bar
#Inicia Procedimentos
echo -e "${cor[0]} $(fun_trans "Digite sua nova senha")"
msg -bar
...
echo -e "${cor[2]} $(fun_trans "Sua senha agora é"): ${cor[4]}$pass"
msg -bar
return
}
...
clear
msg -bar
echo -e "${cor[3]}  Esta ferramenta altera para usuário root o VPS de "
echo -e "${cor[3]}             GoogleCloud e Amazon"
msg -bar
echo -ne " Deseja seguir? [S/N]: "; read x
[[ $x = @(n|N) ]] && msg -bar && return
msg -bar
#Inicia Procedimentos
...
msg -bar
echo -e "Digite sua senha root atual ou altere-a"
msg -bar
read  -p " Nova Senha: " pass
(echo $pass; echo $pass)|passwd 2>/dev/null
sleep 1s
msg -bar
echo -e "${cor[3]} Configurações aplicadas com sucesso!"
echo -e "${cor[2]} Sua senha agora é: ${cor[4]}$pass"
service ssh restart > /dev/null 2>&1
msg -bar
return
}
...
pamcrack () {
echo -e "${cor[3]} $(fun_trans "Liberar senha para VURTL")"
msg -bar
echo -ne " $(fun_trans "Deseja seguir?") [S/N]: "; read x
[[ $x = @(n|N) ]] && msg -bar && return
echo -e ""
...
echo -e " DATA MX LOCAL APLICADA!"
}

timearg () {
rm -rf /etc/localtime
ln -sf /usr/share/zoneinfo/America/Argentina/Buenos_Aires /etc/localtime
echo -e " DATA ARG LOCAL APLICADA!"
}
...
msg -bar
while true; do
echo -e "${cor[4]} [1] > \033[1;36mATUALIZAR VPS"
echo -e "${cor[4]} [2] > \033[1;36mREINICIAR SERVIÇOS"
echo -e "${cor[4]} [3] > \033[1;36mREINICIAR VPS"
echo -e "${cor[4]} [4] > \033[1;36mALTERAR NOME DO HOST VPS"
echo -e "${cor[4]} [5] > \033[1;36mALTERAR SENHA DO  ROOT"
echo -e "${cor[4]} [6] > \033[1;36mALTERAR HORA LOCAL MX"
echo -e "${cor[4]} [7] > \033[1;36mALTERAR HORA LOCAL MX"
echo -e "${cor[2]} [8] > \033[1;100mADICIONAR ROOT a GoogleCloud e Amazon \033[0;37m"
echo -e "${cor[4]} [0] > VOLTA"
while [[ ${opx} != @(0|[1-9]) ]]; do
msg -bar
echo -ne " Selecione uma opção: \033[1;37m" && read opx
tput cuu1 && tput dl1
done
case $opx in
	0)
