...
IP="$(fun_ip)"
echo -e "\033[1;96mGestor de Arquivo FTP VPS•MX"
msg -bar
echo -e "${cor[4]} [1] >${cor[3]} $(fun_trans "Colocar arquivo on-line")"
echo -e "${cor[4]} [2] >${cor[3]} $(fun_trans "Remover arquivo Online")"
echo -e "${cor[4]} [3] >${cor[3]} $(fun_trans "Ver Links de arquivo Online")"
msg -bar
...
[[ -z $(ls /var/www/html) ]] && echo -e "$barra"  || {
    ...
    msg -bar
    echo -e "${cor[5]}$(fun_trans "Selecione o arquivo que deseja excluir")"
    msg -bar
