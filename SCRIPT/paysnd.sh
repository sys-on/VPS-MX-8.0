...
err_fun () {
echo -e "${cor[5]} Operação inválida"
exit
}
echo -e "${cor[5]} Payload Bruta Force By Mod MEX"
msg -bar
gerar_pay () {
# Coletando Host
while [[ ! ${value1} ]]; do
...
while true; do
echo -e " [1]-Testear um Payload"
echo -e " [2]-Testear Payloads Registrada"
msg -bar
read -p " [1-2]: " opx
case $opx in
1)
read -p " Digite uma Payload: " payloadx
...
read -p " Digite o Proxy/o Dropbear: " hostprox
read -p " Digite a Porta: " portx
msg -bar
break
;;
