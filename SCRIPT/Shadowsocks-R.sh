...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-R.sh https://raw.githubusercontent.com/SycNET/VPS-MX-8.0/main/ArchivosUtilitarios/Instalador-Shadowsocks-R.sh > /dev/null 2>&1
